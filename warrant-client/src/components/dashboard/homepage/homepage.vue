  ...
  <div id="home">
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-1/2 xl:w-1/4 px-1">
        ...
        >
          <svg
            class="w-10 h-10 fill-current mr-4 hidden lg:block"
            viewBox="0 0 20 20"
          >
            <path
      ...
      <div class="w-1/2 xl:w-1/4 px-1">
        <div
          class="w-full bg-white border text-yellow-400 rounded-lg flex items-center p-6 mb-6 xl:mb-0"
        >
          <svg
            class="w-10 h-10 fill-current mr-4 hidden lg:block"
            viewBox="0 0 20 20"
      ...
      <div class="w-1/2 xl:w-1/4 px-1">
        <div
          class="w-full bg-white border text-green-400 rounded-lg flex items-center p-6"
        >
          <svg
            class="w-10 h-10 fill-current mr-4 hidden lg:block"
            viewBox="0 0 20 20"
          ...
          <div class="text-gray-700">
            ...
            <p>Executed Warrants</p>
          </div>
        </div>
      </div>
    </div>

    <!-- <div class="w-full h-20 bg-white rounded-lg mb-6 px-6 flex flex-col justify-center items-center">
              <table class="border w-full">
                    <thead class="border text-sm">
                        <tr class="border">
                        <th class="border py-2">ক্রমিক নং</th>
                        <th class="border">অপরাধের নাম</th>
                        </tr>
                    </thead>
                    <tbody class="text-sm">
                        <tr class="border text-center" v-for="(crimeCategory,index) in crimeCategories" :key="crimeCategory.id">
                            <td class="border">{{index}}</td>
                            <td class="border">{{crimeCategory.name}}</td>
                        </tr>
                    </tbody>
                </table>
            </div> -->
