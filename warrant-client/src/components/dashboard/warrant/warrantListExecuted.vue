    ...
    <div class="flex flex-wrap -mx-3">
      <div class="w-full px-3">
        ...
        <div class="w-full bg-white border rounded-lg px-8 py-6 mb-8 xl:mb-0 ">
          <div
            class="flex flex-col gap-1 lg:flex-row justify-between items-center lg:gap-0"
          >
            <div class="text-sm text-gray-400 font-medium">
              Showing: {{ searchedWarrant.length }} executed warrants
            </div>
            <div
              class="flex flex-col lg:flex-row-reverse mb-2 gap-1.5 items-center"
            >
              <div v-if="selectedField">
                <button
                  @click="selectedField = ''"
                  class="h-6 w-6 focus:border-none"
                >
                  <span>
                    <svg
                      class=""
              ...
              <div class="">
                <div class="relative text-gray-500">
                  ...
                  <select
                    ...
                    class="py-2 text-sm rounded-md pl-6 pr-6 border appearance-none focus:outline-none focus:ring-1 focus:ring-gray-400 focus:text-gray-500"
              ...
              <div class="" v-if="selectedField">
                ...
                >
                  ...
                  <div>
                    <button
                      class="bg-blue-500 py-2 px-3 text-sm rounded-lg text-white"
                      @click="getData()"
                    >
                      Search
                    </button>
                ...
                <div class="" v-else-if="selectedField.type == 'dropdown'">
                  <select
                    v-model="searchText"
                    class="py-2 text-sm rounded-md pl-6 pr-6 border focus:outline-none focus:ring-1 focus:ring-gray-400 focus:text-gray-500"
                    @change="search(selectedField.nameArr)"
                  >
                    <option value="" selected
                      >--{{ selectedField.name }} নির্বাচন করুন--</option
                    >
                    <option
                      v-for="court in courts"
                      :key="court.id"
                      :value="court.name"
                      v-if="selectedField.id == 7"
                      >{{ court.name }}</option
                    >
                    <option
                      ...
                      :key="thana.id"
                      :value="thana.name"
                      v-if="selectedField.id == 5"
                      >{{ thana.name }}</option
                    >
                    <option
                      v-for="warrantType in warrantTypes"
                      :key="warrantType"
                      :value="warrantType"
                      v-if="selectedField.id == 6"
                      >{{ warrantType }}</option
                    >
                    <option
                ...
                <div v-else>
                  <input
                    type="text"
                    class="py-2 text-sm rounded-md pl-6 pr-6 border appearance-none focus:outline-none focus:ring-1 focus:ring-blue-400 focus:text-gray-500"
                    v-model="searchText"
                    :placeholder="selectedField.name + ' লিখুন...'"
          ...
          <div class="h-96 overflow-auto">
            <div
              class="align-middle inline-block min-w-full overflow-hidden sm:rounded-lg border-b"
            >
              <table class="min-w-full">
                ...
                <tbody class="text-sm">
                  ...
                  >
                    <td
                      class="p-2 text-center border-b border-r  border-gray-200"
                    >
                      {{ index + 1 }}
                    </td>
                    <td
                      v-for="field in fields"
                      :key="field.id"
                      class="p-2  border-b border-r  border-gray-200"
                      :class="{
                        'bg-gray-100': selectedField.name == field.name,
                      }"
                    >
                      <p v-if="field.type == 'date'">
                        {{
                          warrant["" + field.nameArr] | moment("ddd, MM Do YY")
                        }}
                      </p>
                    ...
                    <td class="p-2  border border-gray-200">
                      <div
                        class="rounded-full py-1 px-3 bg-green-500 text-white text-center"
  ...
  data() {
    return {
      ...
      fields: [
        ...
        {
          id: "3",
          name: "অন্যান্য আদালতের নাম্বার",
          type: null,
          nameArr: "other_number",
        },
        {
          id: "4",
          name: "কোর্ট হতে প্রেরণের তারিখ",
          type: "date",
          nameArr: "send_date",
        },
        { id: "5", name: "থানা", type: "dropdown", nameArr: "thana_name" },
        {
          ...
          name: "ওয়ারেন্টের ধরন",
          type: "dropdown",
          nameArr: "warrant_type",
        },
        {
          id: "16",
          name: "অপরাধের ধরন",
          type: "dropdown",
          nameArr: "crime_category_name",
        },
        {
          id: "7",
          name: "ইস্যুকারি আদালত",
          type: "dropdown",
          nameArr: "court_name",
        },
        ...
        {
          id: "11",
          name: "আসামির পিতার নাম",
          type: null,
          nameArr: "criminal_father_name",
        },
        {
          id: "12",
          name: "আসামির ঠিকানা",
          type: null,
          nameArr: "criminal_address",
        },
        {
          id: "13",
          name: "মোবাইল নং",
          type: null,
          nameArr: "criminal_mobile_no",
        },
        {
          id: "14",
          name: "আসামির এনআইডি",
          type: null,
          nameArr: "criminal_NID",
        },
        {
          id: "15",
          name: "আসামির জন্ম নিবন্ধন",
          type: null,
          nameArr: "birth_cirtificate",
        },
      ],
      courts: [],
      thanas: [],
