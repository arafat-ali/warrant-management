                ...
                <tbody class="text-sm">
                  <tr class="border-l border-r" v-for="(warrant,index) in searchedWarrant" :key="warrant.id">
                    ...
                    <td class="p-2  border-b  border-gray-200">
                      ...
                      <div class="rounded-full py-1 px-3 bg-yellow-500 text-center text-white" v-if="warrant.is_executed == 0" >
                        Pending
                      </div>
                      <div class="rounded-full py-1 px-3 bg-green-500 text-center text-white" v-if="warrant.is_executed == 1" >
                        Executed
                      </div>
                    </td>
                  </tr>
